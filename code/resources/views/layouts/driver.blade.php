...
<head>
   ...
   <link rel="stylesheet" href="{{ asset('/assetss/vendor/fonts/boxicons.css') }}" />
    <link rel="stylesheet" href="{{ asset('/assetss/vendor/fonts/fontawesome.css') }}" />
    <link rel="stylesheet" href="{{ asset('/assetss/vendor/fonts/flag-icons.css') }}" />

    <!-- Core CSS -->
     <link rel="stylesheet" href="{{ asset('/assetss/vendor/css/rtl/core.css') }}" >
    <link rel="stylesheet" href="{{ asset('/assetss/vendor/css/rtl/theme-bordered.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('/assetss/vendor/libs/typeahead-js/typeahead.css') }}" />
    
    <link rel="stylesheet" href="{{ asset('/assetss/vendor/libs/datatables-bs5/datatables.bootstrap5.css') }}">
<link rel="stylesheet" href="{{ asset('/assetss/vendor/libs/datatables-responsive-bs5/responsive.bootstrap5.css') }}">
<link rel="stylesheet" href="{{ asset('/assetss/vendor/libs/datatables-buttons-bs5/buttons.bootstrap5.css') }}">
...
<body>
        ...
        <div class="layout-container">
            ...
            {{-- <div class=""> --}} {{-- abhishek commented div --}}
                ...
                <nav class="layout-navbar navbar navbar-expand-xl align-items-center bg-navbar-theme"
                   ...
                   <a href="CabDriversDirect.com/dashboard"> <img src="https://cabdriversdirect.com/images/logo.png">    </a>
                        ...
                        <div
                            ...
                            <div class="mb-2 mb-md-0">
                                ...
                                , made with ❤️ by <a href="#" target="_blank"
                                    class="footer-link fw-semibold">Cab Drivers Direct</a>
                            </div>
                            <div>
  ...
  <!--common modal ends-->
    ...
    <script src="{{ asset('/assetss/vendor/libs/hammer/hammer.js') }}"></script>


    <script src="{{ asset('/assetss/vendor/libs/i18n/i18n.js') }}"></script>
    <script src="{{ asset('/assetss/vendor/libs/typeahead-js/typeahead.js') }}"></script>

    <script src="{{ asset('/assetss/vendor/js/menu.js') }}"></script>
    <!-- endbuild -->

    <!-- Vendors JS -->
    <script src="{{ asset('/assetss/vendor/libs/moment/moment.js') }}"></script>
    <script src="{{ asset('/assetss/vendor/libs/datatables/jquery.dataTables.js') }}"></script>
    <script src="{{ asset('/assetss/vendor/libs/datatables-bs5/datatables-bootstrap5.js') }}"></script>
    <script src="{{ asset('/assetss/vendor/libs/datatables-responsive/datatables.responsive.js') }}"></script>
    <script src="{{ asset('/assetss/vendor/libs/datatables-responsive-bs5/responsive.bootstrap5.js') }}"></script>
    <script src="{{ asset('/assetss/vendor/libs/datatables-buttons/datatables-buttons.js') }}"></script>
    <script src="{{ asset('/assetss/vendor/libs/datatables-buttons-bs5/buttons.bootstrap5.js') }}"></script>
