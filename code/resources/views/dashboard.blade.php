...
<!-- Mirrored from pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/html/vertical-menu-template-bordered/app-invoice-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Jun 2022 14:39:58 GMT -->
<head>
    <meta charset="utf-8" />
   ...
   <link rel="stylesheet" href="{{ asset('public/assetss/vendor/fonts/boxicons.css') }}" />
    ...
    <!-- Core CSS -->
     <link rel="stylesheet" href="{{ asset('public/assetss/vendor/css/rtl/core.css') }}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset('public/assetss/vendor/css/rtl/theme-bordered.css') }}" class="template-customizer-theme-css" />
...
<script src="{{ asset('public/assetss/vendor/libs/datatables/jquery.dataTables.j') }}s"></script>
...
<!-- Mirrored from pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/html/vertical-menu-template-bordered/app-invoice-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Jun 2022 14:40:00 GMT -->
</html>
