...
class Driver extends Authenticatable
{
    ...
    protected $fillable = ['driverid', 'username', 'password', 'signupdate','email','phone','businessurl','4seatervehicle','8seatervehicle','estatevehicle','courier','easyaccessvehicle','airportruns'];
