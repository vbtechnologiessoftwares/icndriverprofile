...
class Driver extends Authenticatable
{
    ...
    protected $fillable = ['driverid', 'username', 'password', 'signupdate','email','phone','businessurl','4seatervehicle','6seatervehicle', '8seatervehicle','estatevehicle','courier','executivevehicle','airportruns', 'longdistance', 'offtime_timestamp','offtime_timestamp_created_at','dutystatus','adminapproved','firstname','6seatervehicle','addressline1','addressline2','town','county','postcode','lastname', 'password_reset_required'];
