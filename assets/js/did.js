...
$(document).ready(function(){
    ...
    $('#collapseDID').on('shown.bs.collapse', function() {
        $(".collapse-icon").addClass('bx bxs-minus-circle').removeClass('bx bxs-plus-circle');
    });

    $('#collapseDID').on('hidden.bs.collapse', function() {
    ...
    $('#destination').change(function() {
        $("#destination_error").remove();
    });

    // $('#add_time_conditions').click(function() {
    //     console.log('test');
    //     $("#time_condition_did").slideToggle();
    //     $(".no_show").toggle();
    // });
    ...
    $('#destination_value').change(function() {
        $("#destination_value_error").remove();
    });

    $('#destination_value').keydown(function() {
        $("#destination_value_error").remove();
    });
