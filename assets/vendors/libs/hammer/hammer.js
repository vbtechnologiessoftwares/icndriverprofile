  ...
  var t = {
      840: function (t, e, n) {
        ...
        !(function (r, s, o, a) {
          ...
          var $ = { mousedown: 1, mousemove: 2, mouseup: 4 },
            J = "mousedown",
            K = "mousemove mouseup";
          function Q() {
            (this.evEl = J),
          ...
          var ct = { touchstart: 1, touchmove: 2, touchend: 4, touchcancel: 8 },
            ...
            E(zt, Rt, {
              ...
              getTouchAction: function () {
                var t = this.options.direction,
                  e = [];
                return 6 & t && e.push(St), 24 & t && e.push(At), e;
              },
              ...
              process: function (t) {
                ...
                if (i && r && n) {
                  ...
                  var s = !this.pTime || t.timeStamp - this.pTime < e.interval,
                    o =
                      !this.pCenter ||
                      Z(this.pCenter, t.center) < e.posThreshold;
                  if (
